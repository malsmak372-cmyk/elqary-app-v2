...
const Color kLightPrimary = Color(0xFF1B5E20); // Deep Green
const Color kLightAccent = Color(0xFF2E7D32);
...
const Color kDarkPrimary = Color(0xFF81C784);
const Color kDarkAccent = Color(0xFF66BB6A);
