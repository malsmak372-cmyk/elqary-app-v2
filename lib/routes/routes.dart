...
import '../src/features/religious_sections/screen/religious_sections_screen.dart';
...
class RouteGenerator {
  ...
  static const String religiousSections = '/religious_sections';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case religiousSections:
        return MaterialPageRoute(builder: (_) => const ReligiousSectionsScreen());
