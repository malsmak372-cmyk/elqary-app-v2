...
import '../util/bloc/religious_sections/religious_sections_bloc.dart';
...
class DatabaseTable {
  static Future<void> cachedDataFromDb(
    ...
    try {
      ...
      List<Map<String, Object?>> religiousSections = await db.query('kalem_aqsam');

      BlocProvider.of<ReligiousSectionsBloc>(context).add(
        FetchReligiousSections(religiousSections),
      );
    } catch (e) {
